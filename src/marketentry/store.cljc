(ns marketentry.store
  "SSoT for the Republic of Haiti (HTI) market-entry compliance actor,
...
(defn demo-data
  ...
  `:contracting-authority-category` / `:contract-value-htg` /
  `:claimed-marche-public?` are ground truth for the
  `marche-public-claim-mismatch` flagship check (Arrêté du 23 février
  2026 Art. 3/4/5/6 seuil-de-passation tiers); `:requires-blacklist-
  check?` / `:blacklist-clear?` are ground truth for the conditional
  CNMP Liste Noire verification check."
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Société Anonyme Peyi Byen Ranje" :portal "CNMP / MCI"
             ...
             :contract-value-htg 20000000.0
             :claimed-marche-public? true
             :requires-blacklist-check? true :blacklist-clear? true
             :drafted? false :submitted? false
             :jurisdiction "HTI" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "CNMP / MCI"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :contracting-authority-category :etat-collectivites-departementales-entreprises-publiques
             :contract-value-htg 20000000.0
    ...
    "eng-3" {:id "eng-3" :operator "Société Anonyme Fòs Nasyonal" :portal "CNMP / MCI"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "HTI" :status :intake}
    "eng-4" {:id "eng-4" :operator "Société Anonyme Karayib Konstriksyon" :portal "CNMP / MCI"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "HTI" :status :intake}
    "eng-5" {:id "eng-5" :operator "Société Anonyme Site Solèy Leve" :portal "CNMP / MCI"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :contracting-authority-category :etat-collectivites-departementales-entreprises-publiques
             :contract-value-htg 20000000.0
             :claimed-marche-public? true
             :requires-blacklist-check? true :blacklist-clear? false
             :drafted? false :submitted? false
             :jurisdiction "HTI" :status :intake}}})
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               contracting-authority-category contract-value-htg claimed-marche-public?
                               requires-blacklist-check? blacklist-clear?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    contracting-authority-category        (assoc :engagement/contracting-authority-category contracting-authority-category)
    contract-value-htg                    (assoc :engagement/contract-value-htg contract-value-htg)
    (some? claimed-marche-public?)        (assoc :engagement/claimed-marche-public? claimed-marche-public?)
    (some? requires-blacklist-check?)     (assoc :engagement/requires-blacklist-check? requires-blacklist-check?)
    (some? blacklist-clear?)              (assoc :engagement/blacklist-clear? blacklist-clear?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/contracting-authority-category :engagement/contract-value-htg :engagement/claimed-marche-public?
   :engagement/requires-blacklist-check? :engagement/blacklist-clear?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :contracting-authority-category (:engagement/contracting-authority-category m)
     :contract-value-htg (:engagement/contract-value-htg m)
     :claimed-marche-public? (boolean (:engagement/claimed-marche-public? m))
     :requires-blacklist-check? (boolean (:engagement/requires-blacklist-check? m))
     :blacklist-clear? (boolean (:engagement/blacklist-clear? m))
