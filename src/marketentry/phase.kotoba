(ns marketentry.phase
  "Phase 0->3 staged rollout for the Republic of Haiti (HTI) market-entry
  compliance actor.
    ...
    Phase 3  supervised auto  -- governor-clean, high-confidence
                                 `:engagement/intake` (no filing-facing
  ...
  real CNMP filing package and submitting a real filing / MCI
  Autorisation de Fonctionnement registration request are the two
  real-world acts this actor performs; both are always a human market-
  entry operator's call. `marketentry.governor`'s `:actuation/draft-
  filing`/`:actuation/submit-filing` high-stakes gate enforces the same
